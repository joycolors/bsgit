...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
				<form action="${pageContext.request.contextPath }/workerLogin.action" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post" onsubmit= "return checkForm1()"><input type="hidden" name="did" value="0" />
               <input type="hidden" name="to" value="log"/>
                <div class="uinArea" id="uinArea">
                <label class="input-tips" for="u">帐号：</label>
                <div class="inputOuter" id="uArea">
                    
                    <input type="text" id="workername" name="workername" class="inputstyle"/>
                    <span id="span3"></span>
                </div>
                </div>
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  method="post" action="${pageContext.request.contextPath }/workerRegist.action" onsubmit="return checkForm()"> 
        ...
        <ul class="reg_form" id="reg-ul">
                <li>
                    ...
                    <div class="inputOuter2">
                        <input type="text" id="worker_name" name="worker_name" maxlength="16" class="inputstyle2" onblur="checkUsername()"/>
                        <span id="span1"></span>
                    </div>
                ...
                <label for="passwd" class="input-tips2">密码：</label>
                    <div class="inputOuter2">
                        <input type="password" id="worker_pwd"  name="worker_pwd" maxlength="16" class="inputstyle2"/>
